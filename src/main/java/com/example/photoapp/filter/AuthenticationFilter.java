...
import com.example.photoapp.ui.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        var token = JWT.create().withSubject(username)
        ...
        response.addHeader("UserID", userDto.getUserId().toString());// userId is public id and id is private db
        // generated id (from entity)
